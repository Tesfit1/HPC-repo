...
from utils.data_utils import (
    validate_columns, rename_columns, preprocess_dataframe, build_json_payloads, apply_value_mappings
)
...
form_config = FORM_CONFIGS["VitalSignEOS"]

# Read data from S3
df = read_s3_csv(
    bucket=BUCKET_NAME,
    key=FILE_NAMES["vital_sign_eos"],  # Make sure this key is correct in your config
